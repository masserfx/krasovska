...
const SEED_KPIS = [
  ...
  { month_year: "2026-08", revenue_target: 140000, covers_target: 903, avg_ticket_target: 155, fixed_costs: 163000 },
  ...
  { month_year: "2026-12", revenue_target: 300000, covers_target: 1935, avg_ticket_target: 155, fixed_costs: 178500 },
];
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { rows: existing } = await sql`SELECT * FROM bistro_kpis WHERE month_year = ${month_year}`;
