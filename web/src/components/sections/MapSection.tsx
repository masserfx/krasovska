    ...
    <section className="py-20">
      <Container>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-border shadow-lg">
          ...
          {/* Pin overlay — pointer-events:none propouští klikání na mapu, jen pin je interaktivní */}
          <div
            className={`absolute inset-0 transition-opacity duration-300 ${
              mapActive ? "pointer-events-none opacity-0" : "pointer-events-none"
            }`}
          >
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
              {/* Pulzující kruhy */}
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                <span className="absolute inline-flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 animate-ping rounded-full bg-primary/20" />
                <span
                  className="absolute inline-flex h-24 w-24 -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/10"
              ...
              >
                ...
                >
                  <div className="w-72 overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black/5">
                    {/* Thumbnail */}
          ...
          {/* Click hint overlay — klikni pro interakci s mapou */}
          {!mapActive && (
            <button
